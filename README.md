...
| <a name="input_ssh_key"></a> [ssh\_key](#input\_ssh\_key) | SSH public key to add to the image | `string` | `""` | no |
...
| <a name="input_users"></a> [users](#input\_users) | List of IAM users to attach ssh IAM policy | `list` | `[]` | no |
